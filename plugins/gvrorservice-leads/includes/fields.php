...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'gvrorservice-leads' ),
				'storm'       => __( 'Storm or hail damage', 'gvrorservice-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'gvrorservice-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'gvrorservice-leads' ),
				'not-sure'    => __( 'Vet inte än', 'gvrorservice-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'gvrorservice-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'gvrorservice-leads' ),
				'research' => __( 'Jag kollar bara priser', 'gvrorservice-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'gvrorservice-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'gvrorservice-leads' ),
		'contacted' => __( 'Kontaktad', 'gvrorservice-leads' ),
		'quoted'    => __( 'Quote sent', 'gvrorservice-leads' ),
		'won'       => __( 'Won', 'gvrorservice-leads' ),
		'lost'      => __( 'Lost', 'gvrorservice-leads' ),
		'spam'      => __( 'Misstänkt spam', 'gvrorservice-leads' ),
	);
}
