...
$gv_menu = get_posts( array( 'post_type' => 'wp_navigation', 'title' => 'Main menu', 'numberposts' => 1, 'fields' => 'ids', 'post_status' => 'publish' ) );
$gv_ref  = $gv_menu ? '"ref":' . (int) $gv_menu[0] . ',' : '';
?>
...
<div class="wp-block-group"><!-- wp:navigation {<?php echo $gv_ref; // phpcs:ignore ?>"overlayMenu":"mobile","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} /-->

<!-- wp:paragraph {"className":"gv-phone","style":{"typography":{"lineHeight":"1.2"}}} -->
<p class="gv-phone" style="line-height:1.2"><a href="tel:<?php echo esc_attr( gv_lead( 'telefon_tel' ) ); ?>"><?php echo esc_html( gv_lead( 'telefon' ) ); ?></a><small>Vi svarar vard. 07–18</small></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"className":"gv-header-btn"} -->
<div class="wp-block-buttons gv-header-btn"><!-- wp:button {"className":"gv-track-cta"} -->
<div class="wp-block-button gv-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/offert' ) ); ?>">Boka besiktning</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
